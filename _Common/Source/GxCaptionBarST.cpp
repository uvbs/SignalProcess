...
BEGIN_MESSAGE_MAP(CCaptionBarST, CStatic)
	//{{AFX_MSG_MAP(CCaptionBarST)
	ON_WM_PAINT()
	ON_WM_ERASEBKGND()
...
/////////////////////////////////////////////////////////////////////////////
// CCaptionBarST message handlers

void CCaptionBarST::OnPaint() 
{
...
BOOL CCaptionBarST::OnEraseBkgnd(CDC* pDC) 
{
   if (!m_bm.GetSafeHandle())
   {
      MakeCaptionBitmap();
...
//BOOL CCaptionBarST::OnSetText(WPARAM wParam, LPARAM lParam)  PHH
LRESULT CCaptionBarST::OnSetText(WPARAM wParam, LPARAM lParam)
{
...
void CCaptionBarST::MakeCaptionBitmap()
{
	if (m_bm.m_hObject)
