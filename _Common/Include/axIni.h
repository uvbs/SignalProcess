...
public:
	...
	static  CString GetDefaultAppName(void);
...
public:
	...
	static CString	Read_R( CString const& strFileName, CString const& strSection, CString const& strEntry, CString const& strDefault);
	static void		Write_R(CString const& strFileName, CString const& strSection, CString const& strEntry, CString & strValue);
};
